  ...
  return (
    <Center>
      <Box onClick={countNumberOfClicks} zIndex="1">
        <Flex direction="column" align="center" height="100vw" backgroundColor="tertiary" mx="auto" px="20px">
          <GameCounter gameTimeInSeconds={GAME_TIME} clicked={clicked} board={board} points={points} />
