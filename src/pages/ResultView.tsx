...
export const ResultView: React.FC = () => {
  ...
  return (
    <Flex direction="column" align="center" justify="space-around" width="85%" backgroundColor="#ffd803" mx="auto">
      <Center>
        <h2>Results</h2>
      </Center>
      <Link to="/">
        <Button w="150px" m="3px" colorScheme="red" leftIcon={<BsArrowCounterclockwise />}>
          Play again
        </Button>
      </Link>
      <Center>
